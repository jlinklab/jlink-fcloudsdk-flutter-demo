...
class TR {
  ...
  /// `修改分享权限`
  String get modifySharePermission {
    return Intl.message(
      '修改分享权限',
      name: 'modifySharePermission',
      desc: '',
      args: [],
    );
  }
  ...
  /// `权限修改成功`
  String get modifyPermissionSuccess {
    return Intl.message(
      '权限修改成功',
      name: 'modifyPermissionSuccess',
      desc: '',
      args: [],
    );
  }
  ...
  /// `权限修改失败`
  String get modifyPermissionFailed {
    return Intl.message(
      '权限修改失败',
      name: 'modifyPermissionFailed',
      desc: '',
      args: [],
    );
  }
  ...
  /// `背光补偿`
  String get backlightCompensation {
    return Intl.message(
      '背光补偿',
  ...
  /// `智能暖光`
  String get lightModeSmartWarmLight {
    return Intl.message(
      '智能暖光',
      name: 'lightModeSmartWarmLight',
      desc: '',
      args: [],
    );
  }
  ...
  /// `白光全彩`
  String get lightModeWhiteLightFullColor {
    return Intl.message(
      '白光全彩',
      name: 'lightModeWhiteLightFullColor',
      desc: '',
      args: [],
    );
  }
  ...
  String get selectRecordType {
    return Intl.message('选择录像类型', name: 'selectRecordType', desc: '', args: []);
  }

  /// `全部录像`
  String get recordTypeAll {
    return Intl.message('全部录像', name: 'recordTypeAll', desc: '', args: []);
  }

  /// `报警录像`
  String get recordTypeAlarm {
    return Intl.message('报警录像', name: 'recordTypeAlarm', desc: '', args: []);
  }
}
